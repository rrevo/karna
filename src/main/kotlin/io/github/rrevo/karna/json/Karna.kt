...
class Karna(
    val instanceSettings: KarnaSettings = KarnaSettings()
) : ConverterFinder {
    /**
    ...
    inline fun <reified T> parseFromJsonArray(map: JsonArray<*>): List<T>? {
        ...
        map.forEach { jo ->
            if (jo is JsonObject) {
                ...
                else throw KarnaException("Couldn't convert $jo")
            } else if (jo != null) {
                ...
                throw KarnaException("Couldn't convert $jo")
            }
        }
    ...
    fun pathMatcher(po: PathMatcher): Karna {
        pathMatchers.add(po)
        return this
    }
    ...
    fun propertyStrategy(ps: PropertyStrategy): Karna {
     ...
     */
    fun converter(converter: Converter): Karna {
    ...
    fun fieldConverter(annotation: KClass<out Annotation>, converter: Converter): Karna {
     ...
     */
    fun fieldRenamer(renamer: FieldRenamer): Karna {
    ...
    private fun toJsonString(value: Any, converter: Any /* can be Converter or Converter */)
        ...
        val result =
            if (toJsonMethod != null) {
                ...
                throw KarnaException("Couldn't find a toJson() function on converter $converter")
            }
        return result
    }
    ...
    fun fromJsonObject(jsonObject: JsonObject, cls: Class<*>, kc: KClass<*>): Any {
        ...
        return classConverter.fromJson(JsonValue(jsonObject, cls, type, this@Karna)) as Any
    }
